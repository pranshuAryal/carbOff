  ...
  return (
    ...
    >
      ...
      <div className="basis-[750px] flex flex-col p-8 border-r border-gray-200 bg-gray-100 rounded-xl">
        <div className="rounded-lg flex items-center justify-center mb-6 overflow-clip">
          <img
        ...
        <label className="block mb-2 font-medium">
          ...
          <input
            ...
            className="ml-2 mb-2 border rounded px-2 py-1 w-64"
          />
        </label>
        ...
        <div className="w-full  mb-6">
          <label className="block mb-2 font-medium">
            ...
            <input
              ...
              onChange={handleInputChange}
              className="mb-2 border rounded px-2 py-1 w-[126px]"
            />
          </label>
          <button
            onClick={handleCalculate}
            className="mt-4 px-4 py-2 bg-[rgb(98,131,122)] text-white rounded-lg hover:bg-black transition"
